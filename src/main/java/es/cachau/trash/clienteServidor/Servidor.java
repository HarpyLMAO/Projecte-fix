...
public class Servidor {
    ...
    private static List<Server> clientes = Collections.synchronizedList(new ArrayList<>());
    final static int PUERTO = 8100;
    ...
    public static class Server implements Runnable {
        ...
        public void enviarMenuInicial() throws IOException {
                ...
                case "3":
                    ...
                    break;
                default:
                    System.out.println("Error, no se ha seleccionado ninguna opcion, se cierra la sesion");
                    cerrarConexion();
                    break;
            }   
        }
